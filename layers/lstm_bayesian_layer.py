...
from layers.weight_sampler import PriorWeightDistribution # should be local version


class BayesianLSTM(BayesianRNN):
    """
    Bayesian LSTM layer, implements the lstm layer proposed on Weight Uncertainity on Neural Networks
